...
namespace TaskDemo
{
    //https://www.codingame.com/playgrounds/4240/your-ultimate-async-await-tutorial-in-c/async-ready-methods-in--net-framework
    class Program2
    {
        ...
        static void DoSynchronousWorkAfterAwait()
        {
            ...
            //Thread.Sleep(10000); //Delay in parallel
            for (var i = 0; i <= 5; i++)
            {
                for (var j = i; j <= 5; j++)
                {
